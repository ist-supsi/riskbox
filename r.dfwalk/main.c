...
int main(int argc, char *argv[])
{
    ...
    struct Option *input_slim, *input_esp, *input_rw, *input_smean; /* coefficient */
   ...
   int step=0;                            /* step counter (number of cells passed during diffusion)*/
   ...
   double sed_next;                       /* sedimentation of the next cell */
