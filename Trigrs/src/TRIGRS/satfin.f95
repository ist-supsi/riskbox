	subroutine satfin(imx1,ulog,u1,nccs,profil)
...
!
	...
	write(ulog,*) 'Max. terms used by error-function series', nmxs
	write(ulog,*) 'Min. terms used by error-function series', nmns
