...
!	By R.L. Baum and W.Z. Savage, USGS, May 2004
	subroutine pstpi(u1,dhwt,dwt,profil,&
	...
	real (double):: ar1,ar2,ar3,fs,rf(nzs+1)
...
! corrected diffusivity term in next line (divide by b1*b1) 
	          ...
	          term1=0.0
                  if(t1>9.e30) then ! solution for later time...
...
! corrected diffusivity term in next line (divide by b1*b1) 	      
	          ...
	          term2=0.0 
                  if(t2>9.e30) then ! solution for later time...
