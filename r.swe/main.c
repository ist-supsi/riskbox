...
*
* PURPOSE:	Estimate the area potentially inundated on the basis of the 
*		shallow water equations, giving a DTM, and the initial 
*		water depth and velocities in the x and y directions
*
...
int main(int argc, char *argv[]){
  ...
  int infd_ELEV,infd_LAKE, infd_MANNING, infd_U, infd_V;
  ...
  char *ELEV, *LAKE, *MANNING, *U, *V, *OUT_VEL, *OUT_H, *OUT_HMAX, *OUT_VMAX, *OUT_IMAX, *OUT_WAVEFRONT;


  /***********************************************************************************************************************/
  /* GRASS structure */
  struct GModule *module;
  struct Option *input_ELEV, *input_LAKE, *input_MANNING, *input_DELTAT, *input_TSTOP, *input_TIMESTEP, *input_U, *input_V;
  struct
    {
	struct Option *opt_t;
    }
 ...
 /* initialize GRASS */
  ...
  module->description = _("Estimate the area potentially inundated using the shallow water equations");
  ...
  input_LAKE->description = _("Name of initial water depth raster map");
  ...
  if (input_U->answer != NULL && input_V->answer != NULL ) {
	...
	G_warning("Initial velocity only along the north direction");
  	...
  	G_warning("Initial wave velocity null");
  }
  ...
  // default method=3 that is tha normal application of the SWE
  method=3;
  ...
  if (input_U->answer != NULL && input_V->answer != NULL ) {
	...
	/*----------------------------------------------------------------------------------------------*/
	/* qualcosa non va in questo if (CORRETTO! 								*/        
	/*----------------------------------------------------------------------------------------------*/
